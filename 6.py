...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.open_path_text.setPlaceholderText(_translate("Form", "基准文件"))
        self.open_path_but.setText(_translate("MainWindow", "浏览"))
        self.save_path_but.setText(_translate("MainWindow", "浏览"))
        self.save_path_text.setPlaceholderText(_translate("Form", "修改文件"))
        self.save_but.setText(_translate("MainWindow", "对比"))
    ...
    def open_event(self):
        ...
        path = directory1[0]
        self.open_path_text.setText(_translate("MainWindow", path + "xxx"))
        if path is not None:
    ...
    def save_event(self):
        ...
        save_path = fileName2
        self.save_path_text.setText(_translate("MainWindow", save_path))
